...
router.post('/register', strictRateLimit, validateRequest(registerSchema), AuthController.register);
router.post('/login', strictRateLimit, validateRequest(loginSchema), AuthController.login);
