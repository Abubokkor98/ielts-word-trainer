...
import type { GuideSectionData } from './test-format.constants';

// ============================================================================
// Types
// ============================================================================

interface TestFormatSidebarProps {
...
export function TestFormatSidebar({ sections, activeId }: TestFormatSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Test Format Table of Contents" className="space-y-6">
