...
import type { GuideSectionData } from './speaking-criteria.constants';

// ============================================================================
// Types
// ============================================================================

interface SpeakingCriteriaSidebarProps {
...
export function SpeakingCriteriaSidebar({ sections, activeId }: SpeakingCriteriaSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Speaking Criteria Table of Contents" className="space-y-6">
