...
import type { GuideSectionData } from './academic-vs-general.constants';

// ============================================================================
// Types
// ============================================================================

interface AcademicVsGeneralSidebarProps {
...
export function AcademicVsGeneralSidebar({ sections, activeId }: AcademicVsGeneralSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Academic vs General Table of Contents" className="space-y-6">
