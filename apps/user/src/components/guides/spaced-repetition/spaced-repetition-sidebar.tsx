...
import type { GuideSectionData } from './spaced-repetition.constants';

// ============================================================================
// Types
// ============================================================================

interface SpacedRepetitionSidebarProps {
...
export function SpacedRepetitionSidebar({ sections, activeId }: SpacedRepetitionSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Spaced Repetition Table of Contents" className="space-y-6">
