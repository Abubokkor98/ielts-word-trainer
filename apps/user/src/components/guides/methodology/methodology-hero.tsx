  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-base sm:text-lg text-zinc-300 max-w-[58ch] leading-relaxed font-sans mx-auto">
        Learn how our custom-engineered spaced repetition engine, topic grouping, and contextual audio optimize your IELTS vocabulary prep.
      </p>
      <Badge
        variant="secondary"
        className="mt-6 px-4 py-2 text-xs sm:text-sm font-normal text-zinc-400 rounded-full"
      >
        ⚙️ FSRS-5 & SM-2 Algorithmic Learning Architectures
      </Badge>
    </motion.header>
  );
}
