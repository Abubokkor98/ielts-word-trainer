...
import type { GuideSectionData } from './methodology.constants';
...
export function MethodologySidebar({ sections, activeId }: MethodologySidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Our Methodology Table of Contents" className="space-y-6">
