...
import type { GuideSectionData } from './listening-reading-scoring.constants';

// ============================================================================
// Types
// ============================================================================

interface ListeningReadingScoringSidebarProps {
...
export function ListeningReadingScoringSidebar({ sections, activeId }: ListeningReadingScoringSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Scoring Guide Table of Contents" className="space-y-6">
