...
import type { GuideSectionData } from './band-scores.constants';

// ============================================================================
// Types
// ============================================================================

interface BandScoresSidebarProps {
...
export function BandScoresSidebar({ sections, activeId }: BandScoresSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Band Score Guide Table of Contents" className="space-y-6">
