...
import type { PrivacySectionData } from './privacy.constants';
...
interface PrivacySidebarProps {
  readonly sections: readonly PrivacySectionData[];
...
export function PrivacySidebar({ sections, activeId }: PrivacySidebarProps) {
  ...
  return (
    <aside className="hidden lg:block lg:w-1/4 lg:sticky lg:top-28 h-fit pr-4 self-start">
      <nav aria-label="Privacy Policy Table of Contents" className="space-y-6">
